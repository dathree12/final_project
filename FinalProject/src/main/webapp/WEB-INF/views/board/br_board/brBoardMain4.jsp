...
<section class="brboard-body">    
    <section class = "brboard-top">
        ...
        <div class = "brboard-top-menu">
	            ...
	            <li><a href="${path}/board/br_board/brBoardMain4" style="font-weight:bold">인문/사회/역사</a></li>
		            ...
		            <div class="brboard-reviewbox" id="bookreview1">
		                ...
		                <div class="review-description">
		                    <div class="book-description">
		                        ...
		                        <p id="review-booktitle_${board.brNo}" style="margin:0px"></p>
		 ...
		 //나중에 RestTemplate으로 바꾸기
             ...
             $.ajax({
                 ...
                 .done(function (msg) {
                     ...
                     if (msg.documents[0].title.length > 15){
                    	 msg.documents[0].title= msg.documents[0].title.substr(0,14) + "...";
                     }
