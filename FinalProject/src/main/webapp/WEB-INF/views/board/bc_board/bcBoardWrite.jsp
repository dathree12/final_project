...
<p>- 아래 항목은 필수 항목이니 전부 기재해주세요.</p>

<p>- 1차 제안서이니 핵심 사항 위주로 써주세요. 유려한 문장보다 구체적인 정보를 부탁드립니다.</p>

<ul>
	<li>리더명 :</li>
	<li>리더 연락처 (신규 리더/변경시) :</li>
	<li>기존 모임 참가 횟수 :</li> 
</ul>
<p style="color: rgb(243, 121, 52);">없음(신청 불가) / 1회 / 2-10회 / 11-20회 / 20회 이상</p>
...
<p style="color: rgb(243, 121, 52);">지정도서 (같은 책 집에서 읽고와서 감상평 나누기) / 슬로리딩 모임 (현장에서 책 같이 읽고 감상평 나누기) / 강연 / 액티비티 / 워크샵형 모임 (글쓰기, 낭독 등)</p>

<ul>
	<li>도서명 or 컨텐츠   :</li>
	<li>도서/컨텐츠 관련 소개 / 작가소개 / 유튜브 URL    :</li>
</ul>

<ul>
	<li>모임 횟수 (1~8회) :</li>
	<li>가능 요일/시작시간/소요시간 :</li>
	<li>모집 인원 :</li>
	<li>회당 참가비:</li>
	<li>회차별 토픽:</li>
</ul>
<p>*각 항목별로 필수적인 내용을 작성해주세요. 2-3줄 정도로 짧게 작성해주셔도 됩니다. 어려운 질문은 공란으로 두셔도 됩니다.</p>

<p>*해당 질문을 바탕으로 스텝이 모임 인트로와 모임 소개를 작성합니다. 흥미 유발이나 미사여구는 최대한 제외하고 모임의 핵심적인 성격과 내용을 써주세요.</p><br/>



<p><strong><span style="background-color: rgb(255, 229, 153);">-이 모임을 기획한 이유는 무엇인가요?</span></strong></p>



<p><strong><span style="background-color: rgb(255, 229, 153);">-이 모임에 참여한 사람들은 어떤 것을 얻어 갈 수 있나요?</span></strong></p> 

<p><strong>(리더님이 생각할 때 얻어 갈 수 있는 모든 점을 써주세요. 가시적인 것이 아니라도 좋습니다.)</strong></p>

<p>ex)  책을 읽고 디테일한 나눔, 사려깊은 나눔, 더 깊은 감상, 지금 우리 주변 사람들에 대한 이해 / 나에 대한 이해, 그것을 통해 성장하기 /투자 기초 지식과 기업을 분석할 수 있는 시각(기초)</p>



<p><mark>-모임에서는 어떤 활동을 하나요?</mark></p>

<p>ex) 자유 대화 / 발제, 토픽이 있는 감상 나눔 / 액티비티(활동 종류 기재) / 루틴 인증(인증 종류 기재)</p>



<p><mark>-이 모임의 핵심 키워드/핵심 활동/핵심 방향/핵심 매력을 다섯가지 항목으로 말해주세요.</mark></p>

<p>(모임에서 다루는 구체적인 것들을 직관적으로 써주세요. 추상적인 내용은 최대한 배제해주시면 좋아요.)</p>

ex)</br><img src="${ path }/images/write_example.png"/>

<ul>
	<li>(선택) 사용하시는 SNS가 있다면 알려주세요. (브런치, 페이스북, 인스타그램, 블로그 어떤 것이라도 좋습니다)</li>
	<li>(선택) 추가적으로 보낼 이미지가 있을시 첨부해주세요</li>
</ul>
                </pre>
                </textarea>
                <!--  
