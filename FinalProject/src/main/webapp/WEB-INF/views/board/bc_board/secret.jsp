...
<body>
    <div class="secret-form">
		...
		<form name="frm" action="${ path }/board/bc_board/bcBoardList" method="get" id="post_form">
			<div style="margin: auto; text-align: center; margin-top: 30px; line-height: 1px;"><label style="width: 83px; vertical-align: middle; font-size: 20px; font-weight: 900;">비밀번호<input id="proposePwd" name="proposePwd" type="password" style="height: 30px; margin-left: 30px; border: 1px solid #d4d6d6;"></label></div>
			<br/>
